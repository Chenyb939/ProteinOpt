    ...
    with open(path, 'r') as file:
        ...
        for line in lines:
            if line.startswith('Position'):
                pos_line = line.split(' ')
                position_lst.append(int(pos_line[1]))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--vip_result', type=str, default='./reports.txt', help='VIP report')
    ...
    pos_lst = get_mutant_pos(args.vip_result, args.chain)
